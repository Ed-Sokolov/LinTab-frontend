                    ...
                    <div className="main_content">
                        <ul className="information">
                            <li className="created_at">
                                <Created created_at={created_at} updated_at={updated_at}/>
                            </li>
                            <li className="views">
                        ...
                        <H6>{title}</H6>
                        <p className="author">by <NavLink to={`/users/${author_id}`}
                                                          className="custom_link">author</NavLink></p>
